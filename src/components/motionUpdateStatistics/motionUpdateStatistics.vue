    ...
    <div ref="motionUpdateStatistics" class="motionUpdateStatistics">
        ...
        <div class="search" v-if="!$store.state.sportExerciseUpdateList">
            <ul class="clearfix titleul">
                ...
                <li>
                    <el-button @click="search" style="margin-left:4px;background:#83BDF9;color:#fff;">查询</el-button>
                </li>
                <li>
                    <a id="downlink"></a>
    ...
    export default {
        ...
        methods:{
            ...
            handleSizeChange(val) {
                ...
                http.get('/api/auth/v1/sportExercise/updateList',this.page).then(data=>{
            ...
            getTableData(){
                this.loading = true;
                http.get('/api/auth/v1/sportExercise/updateList',this.page).then(res=>{
